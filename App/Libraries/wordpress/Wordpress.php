...
class Wordpress
{
	...
	public function sendPost ( $postInf, $post_type, $title, $excerpt, $content, $thumbnail = '' )
	{
		...
		if ( ! function_exists( 'mime_content_type' ) )
		{
			return [
				'status'    => 'error',
				'error_msg' => fsp__( 'Posts won\'t be shared because of missing the required <a href=\'https://www.fs-poster.com/documentation/commonly-encountered-issues#issue6\' target=\'_blank\'>fileinfo</a> extension. Please ask your hosting/server administrator to install it. <a href=\'https://www.fs-poster.com/documentation/commonly-encountered-issues#issue6\' target=\'_blank\'>How to?</a>' )
			];
		}
