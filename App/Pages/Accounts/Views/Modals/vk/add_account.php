	...
	<div class="fsp-vk-steps">
		<div class="fsp-form-group fsp-vk-step" data-step="1">
			<label class="fsp-is-jb">
				...
				<a href="https://www.fs-poster.com/documentation/fs-poster-schedule-share-wordpress-posts-to-vk-automatically" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>">
...
<script>
	jQuery( document ).ready( function () {
		FSPoster.load_script( '<?php echo Pages::asset( 'Accounts', 'js/fsp-accounts-vk.js' ); ?>' );
	} );
</script>
