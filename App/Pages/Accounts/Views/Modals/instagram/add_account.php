...
<div class="fsp-modal-body">
	<p class="fsp-modal-p fsp-is-jb">
		...
		<a href="https://www.fs-poster.com/documentation/fs-poster-schedule-auto-publish-wordpress-posts-to-instagram" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>">
