...
( function ( $ ) {
	...
	doc.ready( function () {
		...
		doc.on( 'change', '#fspRowsSelector, #fspFilterSelector', function () {
			...
			FSPoster.confirm( fsp__( 'Clearing logs will also erase insights in the dashboard. Are you sure you want to clear logs?' ), function () {
			...
			$( '#fspLogs' ).append( `
				<div class="fsp-log">
					...
					<div class="fsp-log-stats">
						${ ['linkedin', 'reddit', 'tumblr', 'google_b', 'telegram', 'medium', 'wordpress', 'blogger'].includes(result[ 'data' ][ i ][ 'driver' ]) ? '' : `
