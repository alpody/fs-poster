...
<div class="fsp-settings-row">
	<div class="fsp-settings-col">
		...
		<div class="fsp-settings-label-subtext"><?php echo fsp__( 'Link card view – shares the post link and the custom message;<br>Only custom message – shares the custom message without any image or link;<br>Only the featured image - Shares the featured image and the custom message;<br>All post images - Shares all post images as an album and the custom message.', [], FALSE ); ?></div>
	</div>
	<div class="fsp-settings-col">
		<select name="fs_google_b_posting_type" id="fspGoogleBPostingType" class="fsp-form-select">
			...
			<option value="2" <?php echo Helper::getOption( 'google_b_posting_type', '1' ) == '2' ? 'selected' : ''; ?>><?php echo fsp__( 'Only the featured image' ); ?></option>
